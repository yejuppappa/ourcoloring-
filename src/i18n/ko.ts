export default {
  ...
  hero: {
    title: "사진 한 장으로\n우리 아이 색칠공부 만들기",
    subtitle:
      "내 아이 사진, 반려동물, 장난감 — 무엇이든 색칠공부 도안으로 변환해줘요.",
  },
  converter: {
  ...
  landing: {
    ...
    seoContent:
      "사진 색칠공부, 색칠도안, 색칠하기, 색칠놀이 — 어떤 사진이든 깨끗한 선화로 변환합니다. 우리 아이 사진, 가족 사진, 반려동물 사진을 색칠공부 도안으로 바꿔보세요. 프린트해서 아이와 함께 즐기는 색칠놀이! 로그인 없이, 앱 설치 없이, 무료로 사용하세요.",
